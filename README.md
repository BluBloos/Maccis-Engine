**IMPORTANT NOTE: This project will no longer be worked on. Please see the following repos: https://github.com/BluBloos/Automata-Engine, https://github.com/BluBloos/MonkeyDemo**
